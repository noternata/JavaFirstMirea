...
public class UserTest {
    ...
    public void setUp() throws Exception {
        user = new User(Position.PATIENT,"Евгений", 35, Gender.MALE);
        user1 = new User(Position.PATIENT,"Марина", 34, Gender.FEMALE);
        user2 = new User(Position.PATIENT,"Алина", 7, Gender.FEMALE);
    }
